...
def kind1(time_stamp, is_sleep=True, limit=10, time_line=60):
    """
    :return:
    """
    if is_sleep:
        log.info(u"开始执行kind1的操作")
        curl_resource_verbose(time_stamp, 0, 0, limit, 'linux', 'windows', True, True)
        ...
        curl_resource_verbose(time_stamp, 2, 1, limit, 'linux', 'iphone', True, True)
        ...
        curl_resource_verbose(time_stamp, 0, 1, limit, 'linux', 'windows', True, True)
        log.info(u'curl httpcache category=1 成功')
        curl_resource_verbose(time_stamp, 2, 2, limit, 'linux', 'windows', True, True)
        log.info(u'curl videocache category=2 成功')
        curl_resource_verbose(time_stamp, 2, 14, limit, 'linux', 'iphone', True, True)
...
def kind2(time_stamp, is_sleep=True, limit=10, time_line=60):
    if is_sleep:
        log.info(u"开始执行kind2的操作")
        curl_resource_verbose(time_stamp, 0, 2, limit, 'linux', 'windows', True, True)
        ...
        curl_resource_verbose(time_stamp, 2, 4, limit, 'linux', 'iphone', True, True)
        ...
        curl_resource_verbose(time_stamp, 2, 5, limit, 'linux', 'windows', True, True)
        log.info(u'curl videocache category=5 成功')
        curl_resource_verbose(time_stamp, 0, 3, limit, 'linux', 'iphone', True, True)
        log.info(u'curl httpcache category=3 成功')
        curl_resource_verbose(time_stamp, 2, 15, limit, 'linux', 'windows', True, True)
...
def kind3(time_stamp, is_sleep=True, limit=10, time_line=60):
    if is_sleep:
        log.info(u"开始执行kind3的操作")
        curl_resource_verbose(time_stamp, 1, 0, limit, 'linux', 'windows', True, True)
        log.info(u'curl mobilecache category=0 成功')
        curl_resource_verbose(time_stamp, 2, 6, limit, 'linux', 'iphone', True, True)
        log.info(u'curl videocache category=6 成功')
        curl_resource_verbose(time_stamp, 0, 4, limit, 'linux', 'windows', True, True)
        ...
        curl_resource_verbose(time_stamp, 2, 8, limit, 'linux', 'windows', True, True)
        log.info(u'curl videocache category=8 成功')
        curl_resource_verbose(time_stamp, 0, 0, limit, 'linux', 'windows', True, True)
        log.info(u'curl httpcache category=0 成功')
        curl_resource_verbose(time_stamp, 2, 16, limit, 'linux', 'windows', True, True)
...
def kind4(time_stamp, is_sleep=True, limit=10, time_line=60):
    if is_sleep:
        ...
        curl_resource_verbose(time_stamp, 1, 1, limit, 'linux', 'windows', True, True)
        log.info(u'curl mobilecache category=1 成功')
        curl_resource_verbose(time_stamp, 2, 10, limit, 'linux', 'iphone', True, True)
        ...
        curl_resource_verbose(time_stamp, 2, 11, limit, 'linux', 'windows', True, True)
        log.info(u'curl videocache category=11 成功')
        curl_resource_verbose(time_stamp, 0, 2, limit, 'linux', 'windows', True, True)
        log.info(u'curl httpcache category=2 成功')
        curl_resource_verbose(time_stamp, 2, 19, limit, 'linux', 'windows', True, True)
...
def kind5(time_stamp, is_sleep=True, limit=10, time_line=60):
    if is_sleep:
        log.info(u"开始执行kind5的操作")
        curl_resource_verbose(time_stamp, 2, 11, limit, 'linux', 'iphone', True, True)
        log.info(u'curl videocache category=11 成功')
        curl_resource_verbose(time_stamp, 1, 0, limit, 'linux', 'windows', True, True)
        log.info(u'curl mobilecache category=0 成功')
        curl_resource_verbose(time_stamp, 0, 3, limit, 'linux', 'windows', True, True)
        log.info(u'curl httpcache category=3 成功')
        log.info(u'现在的时间是' + str(datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')))
        log.info(u'等待两分钟后继续执行')
        log.info(u'现在的时间是' + str(datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')))
        ...
        curl_resource_verbose(time_stamp, 2, 13, limit, 'linux', 'windows', True, True)
