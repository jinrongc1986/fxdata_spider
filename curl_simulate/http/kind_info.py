...
from curl_simulate.tools.curl_kind import kind1, kind2, kind3, kind4, kind5
...
def kind_info_verbose(time_stamp, kind=1):
    ...
    log.info(message)
    f.write('mobilecache:' + str(mobilecache_count) + ' total_size:' + str(mobilecache_size_total/1024/1024) + 'mb\n')
    ...
    if mobile_android != 0:
        f.write('mobile_android:' + str(mobile_android) + ' total_size:' + str(mobile_android_size_total/1024/1024) + 'mb\n')
    if mobile_ios != 0:
    ...
    if video_miaopai != 0:
        f.write('video_miaopai:' + str(video_miaopai) + ' total_size:' + str(video_miaopai_size_total/1024/1024) + 'mb\n')
    if video_sohu != 0:
        f.write('video_sohu:' + str(video_sohu) + ' total_size:' + str(video_sohu_size_total/1024/1024) + 'mb\n')
    if video_fenghuang != 0:
        f.write('video_fenghuang:' + str(video_fenghuang) + ' total_size:' + str(video_fenghuang_size_total/1024/1024) + 'mb\n')
    if video_netease != 0:
        f.write('video_netease:' + str(video_netease) + ' total_size:' + str(video_netease_size_total/1024/1024) + 'mb\n')
    if video_ads != 0:
    ...
    if video_bilibili != 0:
        f.write('video_bilibili:' + str(video_bilibili) + ' total_size:' + str(video_bilibili_size_total/1024/1024) + 'mb\n')
    if video_moc != 0:
        f.write('video_moc:' + str(video_moc) + ' total_size:' + str(video_moc_size_total/1024/1024) + 'mb\n')
    if video_jidong != 0:
        f.write('video_jidong:' + str(video_jidong) + ' total_size:' + str(video_jidong_size_total/1024/1024) + 'mb\n')
    if video_tecent != 0:
        f.write('video_tecent:' + str(video_tecent) + ' total_size:' + str(video_tecent_size_total/1024/1024) + 'mb\n')
    if video_sina != 0:
    ...
    if video_fenxing != 0:
        f.write('video_fenxing:' + str(video_fenxing) + ' total_size:' + str(video_fenxing_size_total/1024/1024) + 'mb\n')
    if video_icntv != 0:
        f.write('video_icntv:' + str(video_icntv) + ' total_size:' + str(video_icntv_size_total/1024/1024) + 'mb\n')
    if video_mongotv != 0:
        f.write('video_mongotv:' + str(video_mongotv) + ' total_size:' + str(video_mongotv_size_total/1024/1024) + 'mb\n')
