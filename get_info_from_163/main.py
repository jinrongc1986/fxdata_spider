...
from get_info_from_163.tools.curl_kind import kind1, kind2
...
def main_kind():
    ...
    timer_customize(time_stamp, '2017-03-28 17:10:00', '2017-03-28 18:00:00')
...
if __name__ == '__main__':
    # del_all_log()
    main_kind()
    # curl_resource_verbose("2017-03-28-16-45", 2, 13, 10, 'linux', 'windows')
